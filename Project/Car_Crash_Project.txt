...
def car1(pixel):
   ...
   # for b in range(5):
    ...
    for i in range(100):
        MidPointcircle_water(215 + i +x_axis, 350 + y_axis+i, 80 - i)
    flame(pixel)
...
def buildings():
    ...
    MidPointLine(200, 00, 250 + 650, 337 + 95)
    MidPointLine(850,422,850,490)
    MidPointLine(830,422,830,490)
    MidPointLine(830,422,850,422)
    MidPointLine(830,490,850,490)
    for i in range(0,720):
       # print(i)
       glColor3f(0.529, 0.808, 0.922)
       MidPointLine(0,745-i,1000,745-i)
...
def flame(pixel):
    ...
    if pixel == 250:
        ...
        for i in range(770, 870, 3):
            MidPointLine(i, 400 + random.randint(-20, 20), i, 480 + random.randint(-20, 20))
            #print(i, 400 + random.randint(-20, 20), i, 480 + random.randint(-20, 20))
